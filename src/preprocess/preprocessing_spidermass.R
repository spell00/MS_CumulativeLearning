...
path <- 'D://workbench//data//spectro//[SpiderMass]-Databank_Synapt_Beef-liver_Reproducibility//20170228_Bl_Reproducibility/mzXML'
out_filename <- "D://workbench//data//spectro//[SpiderMass]-Databank_Synapt_Beef-liver_Reproducibility//20170228_Bl_Reproducibility"
